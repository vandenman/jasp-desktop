...
RCPP_MODULE(jaspResults)
{
	...
	Rcpp::class_<jaspObject_Interface>("jaspObject")
		...
		.method("dependOnTheseOptions",				&jaspObject_Interface::dependOnTheseOptions,							"Will make the object depend on the current values of the options specified in the charactervector.")
	...
	Rcpp::class_<jaspContainer_Interface>("jaspContainer")
		...
		.property("length",			&jaspContainer_Interface::length,		"How many objects are stored in this container?")
		.method( "[[",				&jaspContainer_Interface::at,			"Retrieve some object from this container as specified under the fieldname")
		.method( "[[<-",			&jaspContainer_Interface::insert,		"Insert some object into this container under a field-name, if this object is a jaspObject and without a title it will get the field-name as title")
	;
	...
	Rcpp::class_<jaspPlot_Interface>("jaspPlot")
		...
		.method("setPlotObjSerialized",		&jaspPlot_Interface::setPlotObjSerialized,								"Stores the plotObj used to generate the graphic, will (should) be stored in a way that is later accesible to saveImage an editImage")
	...
	const std::string addRowsDoc = "Add one or more rows to the object, this class accepts the same datatypes as setdata. If the new data contains more columns that the currently present data empty columns will be added. Before the data is added all existing columns will be given the same length by inserting null-values. Column- and row-names will be extracted as well but used only if the corresponding names aren't set yet.";
	...
	Rcpp::class_<jaspTable_Interface>("jaspTable")
		...
		.method("setData",						&jaspTable_Interface::setData,						"Set the data of the table, this accepts lists, dataframes, matrices and vectors. If any column- or rownames are specified they are set on the object, but only if they aren't set yet.")

		.method("addRow",						&jaspTable_Interface::addRows,						addRowsDoc.c_str())
		.method("addRows",						&jaspTable_Interface::addRows,						addRowsDoc.c_str())
		.method("addRow",						&jaspTable_Interface::addRowsWithoutNames,			addRowsDoc.c_str())
	...
	Rcpp::class_<jaspResults_Interface>("jaspResults")
		...
		.method("setOptions",				&jaspResults_Interface::setOptions,								"Tells jaspResults which options are currently on.")
