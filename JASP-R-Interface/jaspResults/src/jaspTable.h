...
{
public:
	jaspTable(std::string title = "") : jaspObject(jaspObjectType::table, title), _colNames("colNames"), _colTypes("colTypes"), _colTitles("colTitles"), _colFormats("colFormats"), _rowNames("rowNames"), _rowTitles("rowTitles") {}
	...
	void addColumnInfo(Rcpp::RObject name, Rcpp::RObject title, Rcpp::RObject type, Rcpp::RObject format, Rcpp::RObject combine);
...
public:
	...
	void addColumnInfo(Rcpp::RObject name, Rcpp::RObject title, Rcpp::RObject type, Rcpp::RObject format, Rcpp::RObject combine)		{ ((jaspTable*)myJaspObject)->addColumnInfo(name, title, type, format, combine); }
