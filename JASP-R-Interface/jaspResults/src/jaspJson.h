...
public:
	...
	template<int RTYPE> static Json::Value RVectorEntry_to_JsonValue(Rcpp::Vector<RTYPE> obj, int row)				{ return Json::Value(Json::nullValue); }
	template<int RTYPE> static Json::Value RMatrixColumnEntry_to_JsonValue(Rcpp::MatrixColumn<RTYPE> obj, int row)	{ return Json::Value(Json::nullValue); }
